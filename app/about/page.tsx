...
export const metadata: Metadata = generateSEOMetadata({
  title: 'About Isaiah Ozadhe - Software Engineer & Tech Writer',
  description: 'Meet Isaiah Ozadhe, a software engineer with 3+ years of experience in React, Next.js, Python, and modern technologies. Learn about his journey, expertise, and passion for clean code and engineering solutions.',
  url: 'https://blog.isaiahozadhe.tech/about',
  keywords: [
    'Isaiah Ozadhe',
    'software engineer',
