...
function ReplyForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const replyEmail = isAdminReply ? "admin@blog.isaiahozadhe.tech" : userEmail
        ...
        <Card className="p-3 sm:p-4 mt-4 border-primary/20">
            <form onSubmit={handleSubmit} className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <p className="text-xs text-muted-foreground">
                            {isAdmin && userName.trim() === "Post Author" ? (
                                <span className="text-amber-600 dark:text-amber-400 flex items-center gap-1">
                                    ...
                                    As: Post Author (admin@blog.isaiahozadhe.tech)
                                </span>
                            ) : userName.trim() ? (
                                `As: ${userName}`
                            ) : (
                    ...
                    <input
                        type="email"
                        value={isAdmin && userName === "Post Author" ? "admin@blog.isaiahozadhe.tech" : session?.user?.email || ""}
                        disabled
...
function ReplyItem({
    ...
    const canModify = isCurrentUser || (isAdmin && reply.user.email === "admin@blog.isaiahozadhe.tech") // Admin can only edit their own admin comments
                ...
                <div className="flex gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                            ...
                            {reply.user.email === "admin@blog.isaiahozadhe.tech" && (
                                <Badge
                                    variant="outline"
...
function CommentItem({
    ...
    const canModify = isCurrentUser || (isAdmin && comment.user.email === "admin@blog.isaiahozadhe.tech") // Admin can only edit their own admin comments
                    ...
                    <div className="flex gap-2 sm:gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-start gap-2 mb-2 flex-wrap">
                                ...
                                {comment.user.email === "admin@blog.isaiahozadhe.tech" && (
                                    <Badge
                                        variant="outline"
